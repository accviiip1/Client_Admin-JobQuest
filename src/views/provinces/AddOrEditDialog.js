...
const AddOrEditDialog = ({ open, onClose, currentItem, onSubmit, error, setError }) => {
  ...
  return (
    <CModal visible={open} onClose={onClose} size="lg">
      <CModalHeader>
        <CModalTitle>{isEdit ? 'Edit Province' : 'Add Province'}</CModalTitle>
      </CModalHeader>
      <Formik
        enableReinitialize
        initialValues={{
          ...
          nameWithType: currentItem?.nameWithType || '',
        }}
          ...
          <form onSubmit={handleSubmit}>
            <CModalBody>
              ...
              <CRow className="gy-3">
                ...
                <CCol xs={12}>
                  <CFormInput label="Name With Type" name="nameWithType" value={values.nameWithType} onChange={handleChange} />
                </CCol>
              </CRow>
            </CModalBody>
            <CModalFooter>
